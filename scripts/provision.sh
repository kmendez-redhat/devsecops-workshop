...
GITHUB_ACCOUNT=${GITHUB_ACCOUNT:-kmendez-redhat}
...
function deploy() {
 ...
 local template=https://raw.githubusercontent.com/$GITHUB_ACCOUNT/devsecops-workshop/$GITHUB_REF/cicd-template.yaml
